...
Run with jeevn's venv (.venv has requests + GDAL/rasterio):
...
os.environ.setdefault("JEEVN_SRC", r"C:\Users\manan\OneDrive2\Desktop\ashi\src")

from auto_tester.adapters.jeevn_adapter import JeevnAdapter

adapter = JeevnAdapter()
